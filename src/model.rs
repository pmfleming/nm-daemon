...
pub(crate) use network::{
    ...
    HotspotStopResult, HotspotUnavailableReason, NetworkConnectionSummary, NetworkDeactivateResult,
    NetworkDeviceSummary, NetworkInventory, NetworkStateSummary, PrimaryConnectionIdentity,
    ProfileActivationResult, VpnActivationResult, VpnActiveStatus, VpnDisconnectResult,
    VpnProfileSummary, VpnStatus,
};
